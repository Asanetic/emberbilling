...
$novanest_module_ui_blueprint_=[
  ...
  "page_layout"=>[
    ...
    "desired_column_order"=>[
        ...
        'plans' => ['primkey','record_id', "plan_id",'plan_name', "app_id",'currency','pricing_page_message'],
    ...
    "print_tables"=>["billing_transactions"],
    
    //==============================================   ///skip  these columns on the profile page 
    "skip_cols_profile"=>["hive_site_id","hive_site_name"],
        
    ///=============================================   skip  these columns on the list page 
    "skip_cols_list"=>["trx_type" , "business_id" , "client_id" , "admin_id" , "TransactionType" , "BusinessShortCode" , "InvoiceNumber" , "OrgAccountBalance" , "ThirdPartyTransID" , "MSISDN" , "FirstName" , "MiddleName" , "LastName" , "trx_msg" , "account_id" , "used_status" , "filter_date" , "flw_id" , "flag_state" , "reconciled" , "corrected_number" , "hive_site_id" , "hive_site_name"  ,"hive_site_id","hive_site_name","trx_month_year","trx_remark"],
    ...
    "static_drop_down_array"=>["active_status"=>"Active,Inactive","column_name2..."=>"value1,value2,value3"],
    //sample 
    ...
    "dynamic_drop_down_array"=>["plan_type","plan_period","currency"],
    ...
    "rename_cols_array"=>['BillRefNumber'=>'Account number',"app_id"=>"App name", "trx_id"=>"Transaction Ref.","trx_date"=>"Transations date"],
    ...
    "new_label_buttons_arr"=>['plans'=>'plus-circle: Add Subscription plan : Plan / {{plan_id}} / {{plan_name}}'],
    //sample 
  ...
  "data_behaviour"=>[
    ...
    "connection_cols"=>['app_id'=>'app_list:app_id:app_name:/api/emberbill/apps/applications'],
